...
- [Samples](./docs/writing-samples.md)
- [Qiita](https://qiita.com/michiji) (in Japanese)

## Passions 👯

Seeing my impact at early startups, delighting internal and external customers.
...
- Runbooks, test environments, and internal documentation that reduce iterations
- Docs as code: static site generators, Markdown, Git, SVN, make, gradle
